...
function ProjectPage(props) {
  ...
  return (
    <Fragment>
      {imageSelected && (
        <Modal title="meh" message="mess" onConfirm={modalOff}></Modal>
      )}
      <div className={styles.project_page}>
        <div className={styles.project_section} onClick={imageSelectHandler}>
          ...
          <Card className={styles.project_description}>
            ...
            The application has a scraper that will browse all pages of the
            target sites to populate a database with information collected. A UI
            is available offering the possibility of displaying the search
            elements as well as the creation of a user account. An auto search
            feature is integrated through a ternary search tree data structure.
        ...
        <div className={styles.project_section}>
          ...
          <div
            className={`${styles.project_image} ${styles.imgShoppies}`}
          ></div>
        ...
        <div className={styles.project_section}>
          ...
          <div
            className={`${styles.project_image} ${styles.img97_Cartes}`}
          ></div>
        ...
        <div className={styles.project_section}>
          ...
          <Card className={styles.project_description}>
            Simulation of a parking meter with downtown Montreal time
            restriction and pricing.
            <p>== Java ==</p>
          </Card>
        </div>
      </div>
